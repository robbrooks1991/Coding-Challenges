import re
#using * (asterisk) - multiple occurences of the character preceding it
...
print re.findall("ab*c", "ABC")  #[] case sensititve
...
# Combining . with *..........any word beginning with a and ending in c regardless whats in between
print re.findall("a.*c", "abc")                 # ['abc']
...
# sub the tags with 'coming up roses' using the re.sub() method
